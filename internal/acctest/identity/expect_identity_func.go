...
// Adapted from github.com/hashicorp/terraform-plugin-testing/statecheck.ExpectIdentity
func (e expectIdentityFunc) CheckQuery(_ context.Context, req querycheck.CheckQueryRequest, resp *querycheck.CheckQueryResponse) {
	...
	errCollection = append(errCollection, errors.New("an identity with the following attributes was not found"))
...
// Asserts that the given list resource contains a resource with an identity matching
