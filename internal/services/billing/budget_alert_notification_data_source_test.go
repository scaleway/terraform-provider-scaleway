		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.scaleway_billing_budget_alert_notification.main", "recipients.#", "1"),
					resource.TestCheckResourceAttr("data.scaleway_billing_budget_alert_notification.main", "recipients.0", "alerts@example.com"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("data.scaleway_billing_budget_alert_notification.sms", "budget_alert_id", "scaleway_billing_budget_alert_notification.sms", "budget_alert_id"),
					...
					resource.TestCheckResourceAttrPair("data.scaleway_billing_budget_alert_notification.sms", "created_at", "scaleway_billing_budget_alert_notification.sms", "created_at"),
					resource.TestCheckResourceAttrPair("data.scaleway_billing_budget_alert_notification.sms", "updated_at", "scaleway_billing_budget_alert_notification.sms", "updated_at"),
					resource.TestCheckResourceAttr("data.scaleway_billing_budget_alert_notification.sms", "recipients.#", "1"),
					resource.TestCheckResourceAttr("data.scaleway_billing_budget_alert_notification.sms", "recipients.0", "+33612345678"),
				),
			},
		},
	})
