		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("scaleway_billing_budget_alert.main", "organization_id", orgID),
			...
			},
			{
				...
				ImportStateIdFunc: func(state *terraform.State) (string, error) {
					alertID := state.RootModule().Resources["scaleway_billing_budget_alert.main"].Primary.ID
