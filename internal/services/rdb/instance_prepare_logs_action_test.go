...
func TestAccActionRDBInstanceLogPrepare_Basic(t *testing.T) {
	if acctest.IsRunningOpenTofu() {
		t.Skip("Skipping TestAccActionRDBInstanceLogPrepare_Basic because action are not yet supported on OpenTofu")
	}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					isInstanceLogPrepared(tt, "scaleway_rdb_instance.main"),
				),
			},
		},
	})
...
func isInstanceLogPrepared(tt *acctest.TestTools, instanceResourceName string) resource.TestCheckFunc {
