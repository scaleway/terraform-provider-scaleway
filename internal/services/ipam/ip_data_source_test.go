		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.scaleway_ipam_ip.by_mac", "srn", regexp.MustCompile(`^srn://ipam\..+/regions/.+/ips/.+$`)),
					resource.TestMatchResourceAttr("data.scaleway_ipam_ip.by_id", "srn", regexp.MustCompile(`^srn://ipam\..+/regions/.+/ips/.+$`)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.scaleway_ipam_ip.main", "srn", regexp.MustCompile(`^srn://ipam\..+/regions/.+/ips/.+$`)),
				),
			},
		},
	})
