...
func TestAccDataSourceDomainRegistration_Basic(t *testing.T) {
	...
	domainName := sdkacctest.RandomWithPrefix("test-ds-reg-") + ".com"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.scaleway_domain_registration.test", "domain_names.0", domainName),
				),
			},
		},
	})
...
func TestAccDataSourceDomainRegistration_WithProjectID(t *testing.T) {
	...
	domainName := sdkacctest.RandomWithPrefix("test-ds-reg-project-") + ".com"
