...
func flattenPublicNetwork(endpoints []*datawarehouseapi.Endpoint) (interface{}, bool) {
	var publicFlat []map[string]interface{}
...
// flattenPrivateNetwork scans through all endpoints and returns at most one “private_network” block.
// It returns ([]map[string]interface{}, true) if a private endpoint exists, or (nil, false) otherwise.
func flattenPrivateNetwork(endpoints []*datawarehouseapi.Endpoint) (interface{}, bool) {
	var privateFlat []map[string]interface{}
