		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckIotRouteExists(tt, "scaleway_iot_route.default"),
...
func testAccCheckIotRouteExists(tt *acctest.TestTools, n string) resource.TestCheckFunc {
