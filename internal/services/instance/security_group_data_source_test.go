...
func TestAccDataSourceInstanceSecurityGroup_Basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckInstanceSecurityGroupExists(tt, "data.scaleway_instance_security_group.prod"),
					resource.TestCheckResourceAttr("data.scaleway_instance_security_group.prod", "name", securityGroupName),
					testAccCheckInstanceSecurityGroupExists(tt, "data.scaleway_instance_security_group.stg"),
