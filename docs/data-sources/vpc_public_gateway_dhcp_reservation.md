...
- `zone` - (Optional, Computed, Defaults to [provider](../index.md#arguments-reference) `zone`). The [zone](../guides/regions_and_zones.md#zones) in which the reservation exists.
