...
page_title: "scaleway_rdb_instance_restart Action - terraform-provider-scaleway"
subcategory: ""
description: |-
...
# scaleway_rdb_instance_restart (Action)
...
- `instance_id` (String) RDB instance ID to restart. Can be a plain UUID or a regional ID.

### Optional

- `region` (String) The region you want to attach the resource to
- `wait` (Boolean) Wait for the instance restart to complete before returning.
