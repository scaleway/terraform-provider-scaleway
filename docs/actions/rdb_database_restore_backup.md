...
The [`scaleway_rdb_database_restore_backup`](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/actions/rdb_database_backup_restore_action) action restores a backup to an instance.
