...
The [`scaleway_key_manager_rotate_key`](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/actions/key_manager_rotate_key) action is helpful to rotate a key in Key Manager.
