...
- `region` - (Optional, Computed, Defaults to [provider](../index.md#arguments-reference) `region`) The [region](../guides/regions_and_zones.md#regions) in which the customer gateway should be created.
- `project_id` - (Defaults to [provider](../index.md#arguments-reference) `project_id`) The ID of the project the customer gateway is associated with.
...
- `srn` - The Scaleway Resource Name (SRN) of the customer gateway.
