...
- `enable_routing` - (Deprecated) Routing between Private Networks is always enabled on newly created VPCs and cannot be disabled. It will be removed in a future major version.
- `enable_custom_routes_propagation` - (Deprecated) Custom routes propagation between Private Networks is always enabled on newly created VPCs and cannot be disabled. It will be removed in a future major version.
