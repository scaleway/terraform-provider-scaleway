...
> **Important:** The resource `scaleway_container_cron` has been deprecated and will be removed in the future.
Please use `scaleway_container_trigger` with a cron configuration instead.
