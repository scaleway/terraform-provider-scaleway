...
- `region` - (Optional, Computed, Defaults to [provider](../index.md#arguments-reference) `region`) The [region](../guides/regions_and_zones.md#regions) of the VPC connector.
...
- `project_id` - The Scaleway Project the VPC connector belongs to.
...
- `srn` - The Scaleway Resource Name (SRN) of the VPC connector.
