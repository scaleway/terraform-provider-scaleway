...
- `backend_stage_id` - (Optional) The ID of the backend stage to forward requests to after the WAF stage. **Note:** WAF stage is only supported with Load Balancer backends.
