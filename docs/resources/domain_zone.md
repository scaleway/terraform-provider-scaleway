...
- `project_id` - (Defaults to Project ID specified in the [provider configuration](../index.md#arguments-reference) `project_id`) The ID of the Project associated with the domain.
