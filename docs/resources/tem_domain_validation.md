...
- `region` - (Defaults to [provider](../index.md#arguments-reference) `region`). Specifies the [region](../guides/regions_and_zones.md#regions) where the domain is registered. If not specified, it defaults to the provider's region.
