...
- `project_id` - (Defaults to Project ID specified in the [provider configuration](../index.md#arguments-reference)) The ID of the Project the Cockpit is associated with.
