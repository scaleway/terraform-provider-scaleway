...
- `root_volume` - The description of the root volume attached to the image. The `root_volume` block contains :
  - `id` - The ID of the volume.
  - `name` - The name of the volume.
  - `size` - The size of the volume.
  - `volume_type` - The type of volume, possible values are `l_ssd` and `sbs_snapshot`.
- `additional_volumes` - The description of the extra volumes attached to the image. The `additional_volumes` block contains :
  - `id` - The ID of the volume.
  - `name` - The name of the volume.
  - `size` - The size of the volume.
  - `volume_type` - The type of volume, possible values are `l_ssd` and `sbs_snapshot`.
  - `tags` - List of tags associated with the volume.
  - `server` - Description of the server containing the volume (in case the image is a backup from a server). The `server` block contains :
