...
You can use the [scaleway_domain_registration](../data-sources/domain_registration.md) data source to look up the `task_id` by domain name. Registration tasks are archived after some time; once archived, import by domain name instead.
