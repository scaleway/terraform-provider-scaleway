...
- `enable_route_propagation` - (Optional) Defines whether route propagation is enabled or not. Defaults to `false`.
- `region` - (Optional, Computed, Defaults to [provider](../index.md#arguments-reference) `region`) The [region](../guides/regions_and_zones.md#regions) in which the link should be created.
- `project_id` - (Defaults to [provider](../index.md#arguments-reference) `project_id`) The ID of the project the link is associated with.
...
- `srn` - The Scaleway Resource Name (SRN) of the link.
