...
~> **Important:** Object bucket IDs are
[regional](../guides/regions_and_zones.md#resource-ids), which means they are of
the form `{region}/{name}@{project_id}`, e.g.
`fr-par/bucket-name@f9007329-f631-42b3-9ff7-b82d36320014`.
