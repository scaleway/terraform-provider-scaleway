...
~> **Important:** The resource `scaleway_autoscaling_instance_template` has been deprecated and will no longer be supported.
...
- `zone` - (Optional, Computed, Defaults to [provider](../index.md#arguments-reference) `zone`) The [zone](../guides/regions_and_zones.md#zones) in which the Instance template exists.
