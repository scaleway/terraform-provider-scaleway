...
Refer to the Scaleway [Partner documentation](https://www.scaleway.com/en/docs/partner/) and [API documentation](https://www.scaleway.com/en/developers/api/partner/) for more information.
...
- `siren_number` - (Optional) A SIREN number for the customer.
- `comment` - (Optional) A comment about the organization.
