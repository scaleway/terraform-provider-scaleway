...
- `project_id` - (Defaults to the Project specified in the [provider's configuration](../index.md#arguments-reference)) The ID of the Project the Cockpit is associated with.
