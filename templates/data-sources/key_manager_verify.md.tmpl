...
data "scaleway_key_manager_verify" "main" {
  ...
  region = "fr-par"
  digest = "base64digest"
  signature = base64decode(data.scaleway_secret_version.signature.data)
}
```
...
- `digest` - Digest of the original signed message. Must be generated using the same algorithm specified in the key’s configuration, and encoded in Base64.
