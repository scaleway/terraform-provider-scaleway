...
func TestAccScalewayDataSourceAccountSSH_Basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceScalewayAccountSSHKeyConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckScalewayAccountSSHKeyExists("data.scaleway_account_ssh_key.prod"),
					resource.TestCheckResourceAttr("data.scaleway_account_ssh_key.prod", "name", "mordor"),
					...
					resource.TestCheckResourceAttr("data.scaleway_account_ssh_key.stg", "name", "mordor"),
...
var testAccDataSourceScalewayAccountSSHKeyConfig = `
