		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("scaleway_baremetal_private_network.base", "private_networks.0.id", "scaleway_vpc_private_network.pn", "id"),
				),
...
func TestAccScalewayBaremetalPrivateNetwork_AddAnotherPN(t *testing.T) {
	tt := NewTestTools(t)
	defer tt.Cleanup()

	SSHKeyName := "TestAccScalewayBaremetalPrivateNetwork_AddAnotherPN"
	name := "TestAccScalewayBaremetalPrivateNetwork_AddAnotherPN"
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("scaleway_baremetal_private_network.base", "zone", "fr-par-2"),
					resource.TestCheckResourceAttrPair("scaleway_baremetal_private_network.base", "server_id", "scaleway_baremetal_server.base", "id"),
					resource.TestCheckTypeSetElemAttrPair("scaleway_baremetal_private_network.base", "private_networks.*.id", "scaleway_vpc_private_network.pn", "id"),
					resource.TestCheckTypeSetElemAttrPair("scaleway_baremetal_private_network.base", "private_networks.*.id", "scaleway_vpc_private_network.pn2", "id"),
				),
			},
		},
	})
